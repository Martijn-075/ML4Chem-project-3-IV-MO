...
def post_train(model_file="SmilesLSTM_CHEMBL_22_22_epochs.pt", train_file='smiles_CHEMBL_22', save_file="test_popst train.pt", batch_size=1536,learning_rate=0.001, n_epochs=1, device='cuda'):
    """
    This is the entrypoint for training of the RNN
    :param file: A file with molecules in SMILES notation
    :param batch_size: A batch size for training
